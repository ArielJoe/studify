        ...
        <div className="min-h-screen bg-gray-50/50 pb-12">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Dialog open={showStreakPopup} onOpenChange={setShowStreakPopup}>
                            <DialogTrigger asChild>
                                <div
                                    className="ml-auto flex items-center gap-2 bg-orange-100 px-4 py-2 rounded-full cursor-pointer hover:bg-orange-200 transition"
                                    onClick={() => setShowStreakPopup(true)} // Opsional, tapi jelas
                                >
                            ...
                            <DialogContent className="max-w-sm p-0 border-none bg-transparent shadow-none">
                                ...
                                <div className="relative bg-gradient-to-b from-white to-orange-50 rounded-2xl p-10 text-center shadow-xl overflow-hidden">

                                    {/* Glow Background */}
                                    <div className="absolute inset-0 -z-10">
                                        <div className="absolute top-[-40px] right-[-40px] w-40 h-40 bg-orange-400/20 blur-3xl rounded-full"></div>
                                        <div className="absolute bottom-[-40px] left-[-40px] w-40 h-40 bg-orange-300/20 blur-3xl rounded-full"></div>
                                    </div>

                                    {/* Flame Icon */}
                                    <div className="relative mb-3">
                                        <div className="absolute inset-0 blur-xl bg-orange-500/40 rounded-full -z-10 scale-150"></div>
                                        <span className="text-orange-500 text-5xl drop-shadow-md">🔥</span>
                                    </div>
                                    ...
                                    {/* Streak Number */}
                                    <h2 className="text-[110px] font-black text-orange-500 leading-none drop-shadow-sm">
                                        0
                                    </h2>
                                    ...
                                    {/* Watermark */}
                                    <div className="mt-4 text-sky-500 font-semibold text-sm opacity-80 tracking-wide">
                                        © Studify
                                    </div>
                                </div>
            ...
            <main className="max-w-6xl mx-auto px-4 space-y-8">
                ...
                <Card className="shadow-sm border-gray-100 lg:col-span-2">
                    <CardHeader>
                        <CardTitle className="text-lg flex items-center gap-2">
                            <CalendarDays className="w-5 h-5 text-sky-500" />                        Streak Calendar Preview
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <StreakCalendar />
